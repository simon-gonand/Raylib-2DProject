...
void Player::Initialize()
{
	...
	InputComp->BindInput<Player, &Player::BalanceHook>("BalanceHook", RELEASED, this);
	...
	GrapplingHookComp = std::make_shared<GrapplingHookComponent<Renderer2DComponent, CableRendererComponent>>(PlayerSPtr, "assets/Aim/GrapplingHookAim.png", Vector2({1.5f, 1.5f}), 225.0f, 25.0f, 30.0f, 250.0f);
